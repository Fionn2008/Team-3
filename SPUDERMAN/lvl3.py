...
player2_shoot_img = pygame.image.load(join(BASE_DIR, "images", "docockshoot.png")).convert_alpha()
...
def run_level():
    ...
    global is_shooting, doc_is_shooting, shoot_timer, doc_shoot_timer
    global invincible_timer, last_shot_time, doc_last_shot_time, screen_shake
    global has_super_power
